  ...
  <div class="p-4 w-full">
    <ul
      ...
      <li id="homeTab"
        ...
        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-4 mr-3" viewBox="0 0 511 511.999">
          <path
      ...
      <li id="settingTab"
        ...
        <svg xmlns="http://www.w3.org/2000/svg" stroke="currentColor" class="w-4 mr-3" viewBox="0 0 682.667 682.667">
          <defs>
      ...
      <li id="profileTab"
        class="tab relative text-slate-600 hover:text-blue-600 flex items-center justify-center font-medium text-[15px] py-3.5 px-5 border-b-2 border-gray-200 cursor-pointer">
        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-4 mr-3" viewBox="0 0 512 512">
          <path
    ...
    <div id="homeContent" class="tab-content max-w-2xl block mt-8">
      <h4 class="text-base font-semibold text-slate-600">Welcome to your dashboard</h4>
      <p class="text-sm text-slate-600 mt-2 leading-relaxed">This is your personal space where you can monitor activity,
        access important tools, and manage your account.
        Quickly view your recent projects, notifications, and updates all in one place.
        Stay productive by navigating through the tabs to explore content, manage your profile, or start something new.
      </p>
    </div>
    <div id="settingContent" class="tab-content max-w-2xl hidden mt-8">
      <h4 class="text-base font-semibold text-slate-600">Content Management</h4>
      <p class="text-sm text-slate-600 mt-2 leading-relaxed">Here you can manage all your uploaded documents, posts, and
        drafts. You can create new entries, update existing
        content,
        or organize items using tags and folders. Everything is autosaved in real time, so you never lose your work.
        Need to collaborate? Invite team members and assign editing rights as needed.
      </p>
    </div>
    <div id="profileContent" class="tab-content max-w-2xl hidden mt-8">
      <h4 class="text-base font-semibold text-slate-600">Your Profile</h4>
      <p class="text-sm text-slate-600 mt-2 leading-relaxed">This section lets you update your personal information,
        manage your preferences, and customize your experience.
        Add a profile picture, change your display name, connect third-party accounts, or configure notification settings.
        Keeping your profile up to date ensures better collaboration and account security.</p>
    </div>
  </div>
</template>