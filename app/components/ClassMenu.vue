...
<template>
  <div class="p-4 w-full">
    ...
    <div id="homeContent" class="tab-content max-w-2xl block mt-8">
      <h4 class="text-base font-semibold text-slate-600">
      ...
      <p class="text-sm text-slate-600 mt-2 leading-relaxed">
        ...
        projects, notifications, and updates all in one place. Stay productive
        by navigating through the tabs to explore content, manage your profile,
    ...
    <div id="settingContent" class="tab-content max-w-2xl hidden mt-8">
      ...
      <p class="text-sm text-slate-600 mt-2 leading-relaxed">
        Here you can manage all your uploaded documents, posts, and drafts. You
        can create new entries, update existing content, or organize items using
        tags and folders. Everything is autosaved in real time, so you never
        lose your work. Need to collaborate? Invite team members and assign
        editing rights as needed.
      </p>
    </div>
    <div id="profileContent" class="tab-content max-w-2xl hidden mt-8">
      ...
      <p class="text-sm text-slate-600 mt-2 leading-relaxed">
        This section lets you update your personal information, manage your
        preferences, and customize your experience. Add a profile picture,
        change your display name, connect third-party accounts, or configure
        notification settings. Keeping your profile up to date ensures better
        collaboration and account security.
      </p>
    </div>
  </div>
</template>
